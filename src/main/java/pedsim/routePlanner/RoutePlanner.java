...
import pedsim.landmarkNavigation.GlobalLandmarkNavigation;
import pedsim.landmarkNavigation.RegionLandmarkNavigation;
...
public class RoutePlanner {
  ...
  private List<NodeGraph> nodesSequence;
  private Agent agent;
